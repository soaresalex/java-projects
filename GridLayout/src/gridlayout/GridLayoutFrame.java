...
{
    private final JButton[] buttons; // array buttons
    ...
    private final GridLayout gridLayout1; // first gridlayout1
    private final GridLayout gridLayout2; // second gridlayout2

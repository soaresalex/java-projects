...
public class ClassArrays
{
    public static void main(String[] args)
    {
        ...
        int[] intArray = { 1, 2, 3, 4, 5, 8763 };
        int[] intArrayCopy = new int[intArray.length];
        // first element is the element to copy; second element is where to start;
        // third element is where to store the copie array; fourth element where copied array should start
        // fifth specifies the number of elements to copy
